...
const LEVELS = [
  {
    ...
    words: [
      ...
      { en: "welcome", de: "Willkommen", fr: "bienvenue", ar: "أهلاً", tg: "መርሐበ", em: "🤗" },
      { en: "how are you? (m)", de: "Wie geht es dir? (m.)", fr: "comment vas-tu ? (m.)", ar: "كيف حالك؟ (ذ)", tg: "ከፎ ህሌከ?", em: "❓" },
      { en: "how are you? (f)", de: "Wie geht es dir? (w.)", fr: "comment vas-tu ? (f.)", ar: "كيف حالكِ؟ (ث)", tg: "ከፎ ህሌኪ?", em: "❓" },
      { en: "I am fine", de: "Mir geht es gut", fr: "je vais bien", ar: "أنا بخير", tg: "ሰኒ ህሌኮ", em: "😊" },
      { en: "thank you", de: "Danke", fr: "merci", ar: "شكراً", tg: "ሐምደከ", em: "🙏" },
      { en: "yes", de: "Ja", fr: "oui", ar: "نعم", tg: "ኣቤ", em: "✅" },
      { en: "no", de: "Nein", fr: "non", ar: "لا", tg: "ኢኮን", em: "❌" },
      { en: "goodbye", de: "Auf Wiedersehen", fr: "au revoir", ar: "مع السلامة", tg: "ደሐን ትትሌከ", em: "👋" },
      { en: "one", de: "Eins", fr: "un", ar: "واحد", tg: "ሐቴ", em: "1️⃣" },
      { en: "two", de: "Zwei", fr: "deux", ar: "اثنان", tg: "ክልኤ", em: "2️⃣" },
      { en: "three", de: "Drei", fr: "trois", ar: "ثلاثة", tg: "ሰልአስ", em: "3️⃣" },
      { en: "four", de: "Vier", fr: "quatre", ar: "أربعة", tg: "አርበዕ", em: "4️⃣" },
      { en: "five", de: "Fünf", fr: "cinq", ar: "خمسة", tg: "ሐምስ", em: "5️⃣" },
      { en: "six", de: "Sechs", fr: "six", ar: "ستة", tg: "ስስ", em: "6️⃣" },
      { en: "seven", de: "Sieben", fr: "sept", ar: "سبعة", tg: "ሰቡዕ", em: "7️⃣" },
      { en: "eight", de: "Acht", fr: "huit", ar: "ثمانية", tg: "ሰማን", em: "8️⃣" },
      { en: "nine", de: "Neun", fr: "neuf", ar: "تسعة", tg: "ስዕ", em: "9️⃣" },
      { en: "ten", de: "Zehn", fr: "dix", ar: "عشرة", tg: "ዐስር", em: "🔟" },
    ]
  },
  {
    id: 2,
    ...
    icon: "👨‍👩‍👧", color: "#C47B5E",
    words: [
      { en: "father", de: "Vater", fr: "père", ar: "أب", tg: "አብ", em: "👨" },
      { en: "mother", de: "Mutter", fr: "mère", ar: "أم", tg: "እም", em: "👩" },
      { en: "son", de: "Sohn", fr: "fils", ar: "ابن", tg: "ወል/ወድ", em: "👦" },
      { en: "daughter", de: "Tochter", fr: "fille", ar: "بنت", tg: "ወለት", em: "👧" },
      { en: "brother", de: "Bruder", fr: "frère", ar: "أخ", tg: "ሑ", em: "👦" },
      { en: "sister", de: "Schwester", fr: "sœur", ar: "أخت", tg: "ሕት", em: "👧" },
      { en: "boy, child (m)", de: "Junge, Kind (m.)", fr: "garçon, enfant (m.)", ar: "ولد، طفل", tg: "ሕጻን", em: "👶" },
      { en: "girl, child (f)", de: "Mädchen, Kind (w.)", fr: "fille, enfant (f.)", ar: "بنت، طفلة", tg: "ወለት", em: "👶" },
      { en: "man", de: "Mann", fr: "homme", ar: "رجل", tg: "እናስ", em: "🧑" },
      { en: "woman", de: "Frau", fr: "femme", ar: "امرأة", tg: "እሲት", em: "👩" },
  ...
  },
  {
    ...
    icon: "🫀", color: "#D4756B",
    words: [
      { en: "head", de: "Kopf", fr: "tête", ar: "رأس", tg: "ረአስ", em: "🗣️" },
      { en: "eye", de: "Auge", fr: "œil", ar: "عين", tg: "ዕን", em: "👁️" },
      { en: "eyebrow", de: "Augenbraue", fr: "sourcil", ar: "حاجب", tg: "ሐወጅብ", em: "🤨" },
      { en: "eyelash", de: "Wimper", fr: "cil", ar: "رمش", tg: "ስፍር ዕን", em: "😌" },
      ...
      { en: "face", de: "Gesicht", fr: "visage", ar: "وجه", tg: "ገጽ", em: "🙂" },
      { en: "forehead", de: "Stirn", fr: "front", ar: "جبين", tg: "ብሶት", em: "🤔" },
      { en: "neck", de: "Hals", fr: "cou", ar: "رقبة", tg: "ስጋድ", em: "🧣" },
      { en: "shoulder", de: "Schulter", fr: "épaule", ar: "كتف", tg: "ፎቃይ", em: "🤷" },
      { en: "arm", de: "Arm", fr: "bras", ar: "ذراع", tg: "ቅልጭም/ሕርቱመ", em: "💪" },
      { en: "elbow", de: "Ellbogen", fr: "coude", ar: "مرفق", tg: "ምንክብ", em: "🦾" },
      { en: "hand", de: "Hand", fr: "main", ar: "يد", tg: "እዴ", em: "✋" },
      { en: "finger", de: "Finger", fr: "doigt", ar: "إصبع", tg: "ጭብዕት", em: "👆" },
      { en: "fingernail", de: "Fingernagel", fr: "ongle", ar: "ظفر", tg: "ጽፍር እዴ", em: "💅" },
      { en: "chest", de: "Brust", fr: "poitrine", ar: "صدر", tg: "ነሐር", em: "🫁" },
      { en: "rib", de: "Rippe", fr: "côte", ar: "ضلع", tg: "ስጤት/ሰጥያት", em: "🦴" },
      { en: "heart", de: "Herz", fr: "cœur", ar: "قلب", tg: "ልብ", em: "❤️" },
      { en: "belly, stomach", de: "Bauch, Magen", fr: "ventre, estomac", ar: "بطن، معدة", tg: "ከርሸት", em: "🫄" },
      { en: "back", de: "Rücken", fr: "dos", ar: "ظهر", tg: "ዔጻት", em: "🔙" },
      { en: "knee", de: "Knie", fr: "genou", ar: "ركبة", tg: "ብርክ", em: "🦵" },
      { en: "foot, leg", de: "Fuß, Bein", fr: "pied, jambe", ar: "قدم، رجل", tg: "እግር", em: "🦶" },
      { en: "heel", de: "Ferse", fr: "talon", ar: "كعب", tg: "ወታድ", em: "👣" },
      { en: "toe", de: "Zeh", fr: "orteil", ar: "إصبع القدم", tg: "አጫብዕ እግር", em: "🦶" },
      { en: "blood", de: "Blut", fr: "sang", ar: "دم", tg: "ደም", em: "🩸" },
      { en: "bone", de: "Knochen", fr: "os", ar: "عظم", tg: "ዓጭም/ዓጽም", em: "🦴" },
      { en: "skin", de: "Haut", fr: "peau", ar: "جلد", tg: "ቀርበት", em: "🤚" },
    ]
  },
  {
    id: 4,
    ...
    words: [
      ...
      { en: "donkey", de: "Esel", fr: "âne", ar: "حمار", tg: "አድግ", em: "🫏" },
      { en: "foal (baby donkey)", de: "Eselfohlen", fr: "ânon", ar: "جحش", tg: "ህሌለ/ዕሉ", em: "🫏" },
      { en: "dog", de: "Hund", fr: "chien", ar: "كلب", tg: "ከልብ / ኬራይ", em: "🐕" },
      { en: "puppy", de: "Welpe", fr: "chiot", ar: "جرو", tg: "ዕንክር", em: "🐶" },
      { en: "cat", de: "Katze", fr: "chat", ar: "قطة", tg: "ድሙ", em: "🐈" },
      { en: "sheep", de: "Schaf", fr: "mouton", ar: "خروف", tg: "ብግዕት", em: "🐑" },
      { en: "goat (f)", de: "Ziege (w.)", fr: "chèvre (f.)", ar: "عنزة", tg: "ጠሊት", em: "🐐" },
      { en: "kid (baby goat)", de: "Zicklein", fr: "chevreau", ar: "جدي", tg: "ነዊድ", em: "🐐" },
      { en: "chicken, hen", de: "Huhn, Henne", fr: "poulet, poule", ar: "دجاجة", tg: "ዲርሆ", em: "🐔" },
      { en: "chick", de: "Küken", fr: "poussin", ar: "كتكوت", tg: "ጭጭ", em: "🐤" },
      { en: "monkey", de: "Affe", fr: "singe", ar: "قرد", tg: "ሀበይ", em: "🐒" },
      { en: "lion", de: "Löwe", fr: "lion", ar: "أسد", tg: "ሐየት", em: "🦁" },
      { en: "tiger", de: "Tiger", fr: "tigre", ar: "نمر", tg: "ወነን", em: "🐅" },
      { en: "wolf", de: "Wolf", fr: "loup", ar: "ذئب", tg: "ዔክሪብ", em: "🐺" },
      { en: "hyena", de: "Hyäne", fr: "hyène", ar: "ضبع", tg: "ከራይ", em: "🦊" },
      { en: "snake", de: "Schlange", fr: "serpent", ar: "أفعى", tg: "አርዌ", em: "🐍" },
      { en: "bird", de: "Vogel", fr: "oiseau", ar: "طائر", tg: "ሰሬረት/ሰሬራይ", em: "🐦" },
      { en: "fish", de: "Fisch", fr: "poisson", ar: "سمكة", tg: "ዓሰ", em: "🐟" },
      { en: "mouse, rat", de: "Maus, Ratte", fr: "souris, rat", ar: "فأر", tg: "ዐንጻይ", em: "🐁" },
      { en: "pig", de: "Schwein", fr: "cochon", ar: "خنزير", tg: "ከንዚር", em: "🐖" },
      { en: "bee", de: "Biene", fr: "abeille", ar: "نحلة", tg: "ንህበት", em: "🐝" },
      { en: "butterfly", de: "Schmetterling", fr: "papillon", ar: "فراشة", tg: "ጥምብልዔተት", em: "🦋" },
      { en: "ant", de: "Ameise", fr: "fourmi", ar: "نملة", tg: "አቅሕሞተት", em: "🐜" },
      { en: "spider", de: "Spinne", fr: "araignée", ar: "عنكبوت", tg: "ዐንከቦት", em: "🕷️" },
      { en: "scorpion", de: "Skorpion", fr: "scorpion", ar: "عقرب", tg: "አርቀብ", em: "🦂" },
      { en: "mosquito", de: "Mücke", fr: "moustique", ar: "بعوضة", tg: "ሐናኒት/ጫጮት", em: "🦟" },
      { en: "fly", de: "Fliege", fr: "mouche", ar: "ذبابة", tg: "ጭንጫይ", em: "🪰" },
      { en: "louse", de: "Laus", fr: "pou", ar: "قملة", tg: "ቅመለት", em: "🐛" },
    ]
  },
  {
    id: 5,
    ...
    words: [
      ...
      { en: "sky", de: "Himmel", fr: "ciel", ar: "سماء", tg: "ሰመ", em: "🌤️" },
      { en: "earth, land", de: "Erde, Land", fr: "terre", ar: "أرض", tg: "ምድር", em: "🌍" },
      { en: "water", de: "Wasser", fr: "eau", ar: "ماء", tg: "ማይ", em: "💧" },
      { en: "rain", de: "Regen", fr: "pluie", ar: "مطر", tg: "ዝላም", em: "🌧️" },
      { en: "fire", de: "Feuer", fr: "feu", ar: "نار", tg: "እሳት", em: "🔥" },
      { en: "wind", de: "Wind", fr: "vent", ar: "رياح", tg: "ውልዋል/ሀወ/ሸማል", em: "💨" },
      { en: "tree, wood", de: "Baum, Holz", fr: "arbre, bois", ar: "شجرة", tg: "ዕጨት", em: "🌳" },
  ...
  },
  {
    ...
    words: [
      ...
      { en: "bread", de: "Brot", fr: "pain", ar: "خبز", tg: "ሕበዝ", em: "🍞" },
      { en: "meat, flesh", de: "Fleisch", fr: "viande", ar: "لحم", tg: "ስገ", em: "🥩" },
      { en: "butter", de: "Butter", fr: "beurre", ar: "زبدة", tg: "ዝብደት", em: "🧈" },
      { en: "honey", de: "Honig", fr: "miel", ar: "عسل", tg: "መዐር", em: "🍯" },
      { en: "salt", de: "Salz", fr: "sel", ar: "ملح", tg: "ጬወት", em: "🧂" },
      { en: "coffee", de: "Kaffee", fr: "café", ar: "قهوة", tg: "ቡን", em: "☕" },
      { en: "sugar", de: "Zucker", fr: "sucre", ar: "سكر", tg: "ስከር", em: "🍬" },
      { en: "egg", de: "Ei", fr: "œuf", ar: "بيضة", tg: "ቢጨት", em: "🥚" },
      { en: "pepper", de: "Pfeffer", fr: "poivre", ar: "فلفل", tg: "ጉዕ", em: "🌶️" },
      { en: "bean", de: "Bohne", fr: "haricot", ar: "فول", tg: "ፉል", em: "🫘" },
      { en: "leavened bread", de: "Sauerteigbrot", fr: "pain levé", ar: "خبز مخمر", tg: "ሕበዝ ካምር", em: "🫓" },
  ...
  },
  {
    ...
    icon: "🎨", color: "#7B6B9E",
    words: [
      { en: "white", de: "Weiß", fr: "blanc", ar: "أبيض", tg: "ጸዕደ", em: "⬜" },
      { en: "black", de: "Schwarz", fr: "noir", ar: "أسود", tg: "ጸሊም", em: "⬛" },
      { en: "red", de: "Rot", fr: "rouge", ar: "أحمر", tg: "ቀይሕ", em: "🟥" },
      { en: "green", de: "Grün", fr: "vert", ar: "أخضر", tg: "አክደር", em: "🟩" },
      { en: "big, large", de: "Groß", fr: "grand", ar: "كبير", tg: "ዐቢ", em: "📐" },
      { en: "small, little", de: "Klein", fr: "petit", ar: "صغير", tg: "ንኡሽ", em: "🤏" },
      { en: "tall, long", de: "Groß, lang", fr: "grand, long", ar: "طويل", tg: "ረዪም", em: "📏" },
      { en: "short", de: "Kurz", fr: "court", ar: "قصير", tg: "ሐጪር", em: "📏" },
      { en: "good", de: "Gut", fr: "bon", ar: "جيد", tg: "ሰኒ", em: "👍" },
      { en: "bad", de: "Schlecht", fr: "mauvais", ar: "سيء", tg: "እኩይ/ክፉእ", em: "👎" },
      { en: "new", de: "Neu", fr: "nouveau", ar: "جديد", tg: "ሐዲስ", em: "✨" },
      { en: "old (aged)", de: "Alt", fr: "vieux", ar: "قديم", tg: "ገዲም", em: "🕰️" },
      { en: "near", de: "Nah", fr: "proche", ar: "قريب", tg: "ቅሩብ", em: "📍" },
      { en: "many, much", de: "Viel", fr: "beaucoup", ar: "كثير", tg: "ብዙሕ", em: "📊" },
      { en: "pretty, handsome", de: "Hübsch", fr: "beau", ar: "جميل", tg: "ግሩም", em: "🌸" },
      { en: "strong", de: "Stark", fr: "fort", ar: "قوي", tg: "ድቁብ", em: "💪" },
      { en: "brave", de: "Mutig", fr: "courageux", ar: "شجاع", tg: "ሓጥር", em: "🦁" },
    ]
  },
  {
    id: 8,
    ...
    words: [
      ...
      { en: "road, way", de: "Straße, Weg", fr: "route, chemin", ar: "طريق", tg: "ገበይ", em: "🛣️" },
      { en: "name", de: "Name", fr: "nom", ar: "اسم", tg: "ስም/ስሜት", em: "📛" },
      { en: "clothes", de: "Kleidung", fr: "vêtements", ar: "ملابس", tg: "ልባስ", em: "👕" },
      { en: "knife", de: "Messer", fr: "couteau", ar: "سكين", tg: "ጀርደት/ሰኪን", em: "🔪" },
      { en: "book", de: "Buch", fr: "livre", ar: "كتاب", tg: "ክታብ", em: "📖" },
      { en: "sword", de: "Schwert", fr: "épée", ar: "سيف", tg: "ሰይፍ", em: "⚔️" },
      { en: "gold", de: "Gold", fr: "or", ar: "ذهب", tg: "ደሀብ/ወርቅ", em: "🥇" },
      { en: "window", de: "Fenster", fr: "fenêtre", ar: "نافذة", tg: "ሽባክ", em: "🪟" },
      { en: "village, tribe", de: "Dorf, Stamm", fr: "village, tribu", ar: "قرية، قبيلة", tg: "ዐድ", em: "🏘️" },
      { en: "place", de: "Ort", fr: "lieu", ar: "مكان", tg: "አካን", em: "📍" },
      { en: "bed", de: "Bett", fr: "lit", ar: "سرير", tg: "ዐራት", em: "🛏️" },
      { en: "work", de: "Arbeit", fr: "travail", ar: "عمل", tg: "ወቀይ/ሽቅል", em: "⚒️" },
      { en: "year", de: "Jahr", fr: "année", ar: "سنة", tg: "ሖል/ሰነት", em: "📅" },
      { en: "money", de: "Geld", fr: "argent", ar: "مال", tg: "ሰላዲ", em: "💰" },
    ]
  },
  {
    id: 9,
    ...
    words: [
      ...
      { en: "to go", de: "gehen", fr: "aller", ar: "ذهب", tg: "ጌሰ", em: "🚶" },
      { en: "to come", de: "kommen", fr: "venir", ar: "جاء", tg: "መጽአ/ዔረ", em: "🏃" },
      { en: "to see", de: "sehen", fr: "voir", ar: "رأى", tg: "ረአ", em: "👀" },
      { en: "to hear", de: "hören", fr: "entendre", ar: "سمع", tg: "ሰምዐ", em: "👂" },
      { en: "to say, speak", de: "sagen, sprechen", fr: "dire, parler", ar: "قال، تكلم", tg: "ቤለ", em: "🗣️" },
      { en: "to give", de: "geben", fr: "donner", ar: "أعطى", tg: "ሀበ", em: "🤲" },
      { en: "to sleep", de: "schlafen", fr: "dormir", ar: "نام", tg: "ሰክበ", em: "😴" },
      { en: "to know", de: "wissen", fr: "savoir", ar: "عرف", tg: "ኣመረ", em: "🧠" },
      { en: "to read", de: "lesen", fr: "lire", ar: "قرأ", tg: "ቀርአ", em: "📖" },
      { en: "to write", de: "schreiben", fr: "écrire", ar: "كتب", tg: "ከትበ", em: "✍️" },
      { en: "to sit (down)", de: "sich setzen", fr: "s'asseoir", ar: "جلس", tg: "ትገሰ", em: "🪑" },
      { en: "to do, make", de: "tun, machen", fr: "faire", ar: "فعل", tg: "ወደ", em: "🔨" },
  ...
  },
  {
    ...
    icon: "💬", color: "#6B5E8E",
    words: [
      { en: "What is your name?", de: "Wie heißt du?", fr: "Comment t'appelles-tu ?", ar: "ما اسمك؟", tg: "ስሜትከ ምን ተ?", em: "❓" },
      { en: "My name is…", de: "Mein Name ist…", fr: "Mon nom est…", ar: "اسمي…", tg: "ስምዬ/ስሜቼ…", em: "📛" },
      { en: "I know", de: "Ich weiß", fr: "Je sais", ar: "أعرف", tg: "አምር", em: "✅" },
      { en: "I don't know", de: "Ich weiß nicht", fr: "Je ne sais pas", ar: "لا أعرف", tg: "ኢአምር", em: "❌" },
      { en: "please (m)", de: "Bitte (m.)", fr: "s'il te plaît (m.)", ar: "من فضلك (ذ)", tg: "ዐይብከ", em: "🙏" },
      { en: "come here!", de: "Komm her!", fr: "viens ici !", ar: "تعال هنا!", tg: "ነዐ እንሰር", em: "👈" },
      { en: "I am hungry", de: "Ich bin hungrig", fr: "j'ai faim", ar: "أنا جائع", tg: "አነ ስፍሩይ ህሌኮ", em: "😋" },
      { en: "how much?", de: "Wie viel?", fr: "combien ?", ar: "كم؟", tg: "ከም?", em: "💰" },
      { en: "where?", de: "Wo?", fr: "où ?", ar: "أين؟", tg: "እተየ?", em: "📍" },
      { en: "today", de: "Heute", fr: "aujourd'hui", ar: "اليوم", tg: "ዮም", em: "📅" },
      { en: "tomorrow", de: "Morgen", fr: "demain", ar: "غداً", tg: "ፈጅር", em: "📆" },
      { en: "there is / exists", de: "Es gibt", fr: "il y a", ar: "يوجد", tg: "ሀለ", em: "✔️" },
      { en: "there is not", de: "Es gibt nicht", fr: "il n'y a pas", ar: "لا يوجد", tg: "አለቡ", em: "✖️" },
      { en: "goodbye", de: "Auf Wiedersehen", fr: "au revoir", ar: "مع السلامة", tg: "ደሐን ትትሌከ", em: "🤲" },
    ]
  },
  {
    ...
    icon: "🫵", color: "#4E7B8B",
    words: [
      { en: "I", de: "ich", fr: "je", ar: "أنا", tg: "አነ", em: "🙋" },
      { en: "you (m)", de: "du (m.)", fr: "tu (m.)", ar: "أنتَ", tg: "እንተ", em: "🫵" },
      { en: "you (f)", de: "du (w.)", fr: "tu (f.)", ar: "أنتِ", tg: "እንቲ", em: "🫵" },
      { en: "he", de: "er", fr: "il", ar: "هو", tg: "ህቱ", em: "👨" },
      { en: "she", de: "sie", fr: "elle", ar: "هي", tg: "ህተ", em: "👩" },
      { en: "we", de: "wir", fr: "nous", ar: "نحن", tg: "ሕነ", em: "👥" },
      { en: "they (m)", de: "sie (m. Pl.)", fr: "ils", ar: "هم", tg: "ህቶም", em: "👬" },
      { en: "they (f)", de: "sie (w. Pl.)", fr: "elles", ar: "هن", tg: "ህተን", em: "👭" },
      { en: "this (m)", de: "dieser (m.)", fr: "ce (m.)", ar: "هذا", tg: "እሊ", em: "👈" },
      { en: "this (f)", de: "diese (w.)", fr: "cette (f.)", ar: "هذه", tg: "እለ", em: "👉" },
      { en: "what?", de: "was?", fr: "quoi ?", ar: "ماذا؟", tg: "ሚ", em: "❓" },
      { en: "who?", de: "wer?", fr: "qui ?", ar: "من؟", tg: "መን", em: "🤷" },
      { en: "someone (m)", de: "jemand (m.)", fr: "quelqu'un (m.)", ar: "شخص ما", tg: "ኦሮት ነፈር", em: "🧑" },
      { en: "nobody", de: "niemand", fr: "personne", ar: "لا أحد", tg: "ወለ ሐቴ", em: "🚫" },
      { en: "something", de: "etwas", fr: "quelque chose", ar: "شيء ما", tg: "ገሌ ጋር", em: "📦" },
      { en: "nothing", de: "nichts", fr: "rien", ar: "لا شيء", tg: "ሴመ ኢኮን", em: "🕳️" },
      { en: "all, every", de: "alles, jeder", fr: "tout", ar: "كل", tg: "ኩሉ", em: "🌐" },
      { en: "self", de: "selbst", fr: "soi-même", ar: "نفس", tg: "ነፍስ/ርሕ", em: "🪞" },
    ]
  },
  {
    id: 12,
    ...
    words: [
      ...
      { en: "twenty", de: "zwanzig", fr: "vingt", ar: "عشرون", tg: "ዕስረ", em: "2️⃣0️⃣" },
      { en: "thirty", de: "dreißig", fr: "trente", ar: "ثلاثون", tg: "ሰላሰ", em: "3️⃣0️⃣" },
      { en: "forty", de: "vierzig", fr: "quarante", ar: "أربعون", tg: "አርበዐ", em: "4️⃣0️⃣" },
      { en: "fifty", de: "fünfzig", fr: "cinquante", ar: "خمسون", tg: "ሕምሰ", em: "5️⃣0️⃣" },
      { en: "sixty", de: "sechzig", fr: "soixante", ar: "ستون", tg: "ስሰ", em: "6️⃣0️⃣" },
      { en: "hundred", de: "hundert", fr: "cent", ar: "مئة", tg: "ምእት", em: "💯" },
      { en: "number, quantity", de: "Zahl, Menge", fr: "nombre", ar: "عدد", tg: "ዕልብ", em: "#️⃣" },
      { en: "first", de: "erster", fr: "premier", ar: "أول", tg: "ሰልፍ/አዋላይ", em: "🥇" },
      { en: "second", de: "zweiter", fr: "deuxième", ar: "ثاني", tg: "ካልኣይ", em: "🥈" },
      { en: "third", de: "dritter", fr: "troisième", ar: "ثالث", tg: "ሳልእስ/ሳልሳይ", em: "🥉" },
    ]
  },
  {
    id: 13,
    ...
    icon: "🔗", color: "#5E6B8E",
    words: [
      { en: "in, at, to", de: "in, an, zu", fr: "dans, à, en", ar: "في", tg: "እት", em: "📌" },
      { en: "from", de: "von, aus", fr: "de, depuis", ar: "من", tg: "ምን", em: "↗️" },
      { en: "with, by", de: "mit, durch", fr: "avec, par", ar: "مع", tg: "ምስል/እብ", em: "🤝" },
      { en: "for, to", de: "für, zu", fr: "à, pour", ar: "لـ", tg: "እግል/አስክ", em: "🎯" },
      { en: "after, behind", de: "nach, hinter", fr: "après", ar: "بعد", tg: "ሐቆ", em: "⏩" },
      { en: "like, as", de: "wie, als", fr: "comme", ar: "مثل", tg: "ክምሰል", em: "⚖️" },
      { en: "without", de: "ohne", fr: "sans", ar: "بدون", tg: "እምበል", em: "🚫" },
      { en: "and", de: "und", fr: "et", ar: "و", tg: "ወ", em: "➕" },
      { en: "or", de: "oder", fr: "ou", ar: "أو", tg: "እው/ዎክ/ተሩ", em: "↔️" },
      { en: "but", de: "aber", fr: "mais", ar: "لكن", tg: "ደአም", em: "🔄" },
      { en: "when", de: "als, wenn", fr: "quand", ar: "عندما", tg: "ዶል", em: "🕐" },
      { en: "because", de: "weil", fr: "parce que", ar: "لأن", tg: "ሰበት እሊ", em: "💡" },
      { en: "although", de: "obwohl", fr: "bien que", ar: "رغم أن", tg: "ምንመ", em: "🤔" },
  ...
  },
  {
    ...
    icon: "🍎", color: "#D45B6B",
    words: [
      { en: "apple", de: "Apfel", fr: "pomme", ar: "تفاح", tg: "ትፈሕ", em: "🍎" },
      { en: "banana", de: "Banane", fr: "banane", ar: "موز", tg: "በናነ", em: "🍌" },
      { en: "orange", de: "Orange", fr: "orange", ar: "برتقال", tg: "አራንሺ", em: "🍊" },
      { en: "mango", de: "Mango", fr: "mangue", ar: "مانجو", tg: "መንገ", em: "🥭" },
      { en: "pineapple", de: "Ananas", fr: "ananas", ar: "أناناس", tg: "አናናስ", em: "🍍" },
      { en: "grape", de: "Traube", fr: "raisin", ar: "عنب", tg: "ዕነብ", em: "🍇" },
      { en: "watermelon", de: "Wassermelone", fr: "pastèque", ar: "بطيخ", tg: "ብርጪቅ", em: "🍉" },
      { en: "strawberry", de: "Erdbeere", fr: "fraise", ar: "فراولة", tg: "ፈራውለ", em: "🍓" },
      { en: "cherry", de: "Kirsche", fr: "cerise", ar: "كرز", tg: "ምልሕጠ", em: "🍒" },
      { en: "peach", de: "Pfirsich", fr: "pêche", ar: "خوخ", tg: "አባንጉል", em: "🍑" },
      { en: "pear", de: "Birne", fr: "poire", ar: "كمثرى", tg: "ኮሚስ", em: "🍐" },
      { en: "kiwi", de: "Kiwi", fr: "kiwi", ar: "كيوي", tg: "በሀሽ", em: "🥝" },
      { en: "papaya", de: "Papaya", fr: "papaye", ar: "بابايا", tg: "ፓፓዮ", em: "🍈" },
      { en: "lemon", de: "Zitrone", fr: "citron", ar: "ليمون", tg: "ለይሙን", em: "🍋" },
      { en: "lime", de: "Limette", fr: "citron vert", ar: "ليمون أخضر", tg: "ሎቢን", em: "🟢" },
      { en: "coconut", de: "Kokosnuss", fr: "noix de coco", ar: "جوز الهند", tg: "ካካው", em: "🥥" },
      { en: "plum", de: "Pflaume", fr: "prune", ar: "برقوق", tg: "በርጉግ", em: "🫐" },
      { en: "fig", de: "Feige", fr: "figue", ar: "تين", tg: "በለስ", em: "🟣" },
      { en: "guava", de: "Guave", fr: "goyave", ar: "جوافة", tg: "ጀዋፈት", em: "🟢" },
      { en: "avocado", de: "Avocado", fr: "avocat", ar: "أفوكادو", tg: "አቮካዶ", em: "🥑" },
    ]
  },
  {
    id: 15,
    ...
    icon: "🌦️", color: "#5E8EA8",
    words: [
      { en: "sunny", de: "sonnig", fr: "ensoleillé", ar: "مشمس", tg: "ጸሓይ", em: "☀️" },
      { en: "clear, bright", de: "klar", fr: "dégagé", ar: "صافٍ", tg: "ቃውዕ", em: "🌞" },
      { en: "cloudy", de: "bewölkt", fr: "nuageux", ar: "غائم", tg: "ጉዩም", em: "☁️" },
      { en: "rainy", de: "regnerisch", fr: "pluvieux", ar: "ممطر", tg: "ዝላም", em: "🌧️" },
      { en: "windy", de: "windig", fr: "venteux", ar: "عاصف", tg: "ውልዋል", em: "💨" },
...
const DICTIONARY = [
  ...
  { tg: "መርሐበ", en: "welcome", de: "Willkommen", fr: "bienvenue", ar: "مرحبا" },
  { tg: "ከፎ ህሌከ?", en: "how are you? (m)", de: "Wie geht es dir? (m)", fr: "comment vas-tu? (m)", ar: "كيف حالك؟" },
  { tg: "ከፎ ህሌኪ?", en: "how are you? (f)", de: "Wie geht es dir? (f)", fr: "comment vas-tu? (f)", ar: "كيف حالكِ؟" },
  { tg: "ሰኒ ህሌኮ", en: "I am well", de: "Mir geht es gut", fr: "je vais bien", ar: "أنا بخير" },
  { tg: "ሐምደከ", en: "thank you", de: "Danke", fr: "merci", ar: "شكراً" },
  { tg: "ኣቤ", en: "yes", de: "Ja", fr: "oui", ar: "نعم" },
  { tg: "ኢኮን", en: "no", de: "Nein", fr: "non", ar: "لا" },
  { tg: "ደሐን ትትሌከ", en: "goodbye", de: "Auf Wiedersehen", fr: "au revoir", ar: "مع السلامة" },
  { tg: "ሐቴ", en: "one", de: "eins", fr: "un", ar: "واحد" },
  { tg: "ክልኤ", en: "two", de: "zwei", fr: "deux", ar: "اثنان" },
  { tg: "ሰልአስ", en: "three", de: "drei", fr: "trois", ar: "ثلاثة" },
  { tg: "አርበዕ", en: "four", de: "vier", fr: "quatre", ar: "أربعة" },
  { tg: "ሐምስ", en: "five", de: "fünf", fr: "cinq", ar: "خمسة" },
  { tg: "ስስ", en: "six", de: "sechs", fr: "six", ar: "ستة" },
  { tg: "ሰቡዕ", en: "seven", de: "sieben", fr: "sept", ar: "سبعة" },
  { tg: "ሰማን", en: "eight", de: "acht", fr: "huit", ar: "ثمانية" },
  { tg: "ስዕ", en: "nine", de: "neun", fr: "neuf", ar: "تسعة" },
  { tg: "ዐስር", en: "ten", de: "zehn", fr: "dix", ar: "عشرة" },
  { tg: "አብ", en: "father", de: "Vater", fr: "père", ar: "أب" },
  { tg: "እም", en: "mother", de: "Mutter", fr: "mère", ar: "أم" },
  { tg: "ወል/ወድ", en: "son", de: "Sohn", fr: "fils", ar: "ابن" },
  { tg: "ወለት", en: "daughter", de: "Tochter", fr: "fille", ar: "ابنة" },
  { tg: "ሑ", en: "brother", de: "Bruder", fr: "frère", ar: "أخ" },
  { tg: "ሕት", en: "sister", de: "Schwester", fr: "sœur", ar: "أخت" },
  { tg: "ሕጻን", en: "boy, child (m)", de: "Junge, Kind (m)", fr: "garçon, enfant (m)", ar: "ولد" },
  { tg: "ወለት", en: "girl, child (f)", de: "Mädchen, Kind (f)", fr: "fille, enfant (f)", ar: "بنت" },
  { tg: "እናስ", en: "man", de: "Mann", fr: "homme", ar: "رجل" },
  { tg: "እሲት", en: "woman", de: "Frau", fr: "femme", ar: "امرأة" },
  { tg: "አብዕብ", en: "grandfather", de: "Großvater", fr: "grand-père", ar: "جد" },
  ...
  { tg: "አፍ", en: "mouth", de: "Mund", fr: "bouche", ar: "فم" },
  { tg: "ኣንፍ", en: "nose", de: "Nase", fr: "nez", ar: "أنف" },
  { tg: "ንሳል", en: "tongue", de: "Zunge", fr: "langue", ar: "لسان" },
  { tg: "ኒብ", en: "tooth", de: "Zahn", fr: "dent", ar: "سن" },
  { tg: "እዴ", en: "hand", de: "Hand", fr: "main", ar: "يد" },
  { tg: "እግር", en: "foot, leg", de: "Fuß, Bein", fr: "pied, jambe", ar: "قدم" },
  { tg: "ልብ", en: "heart", de: "Herz", fr: "cœur", ar: "قلب" },
  { tg: "ከርሸት", en: "belly, stomach", de: "Bauch, Magen", fr: "ventre, estomac", ar: "بطن" },
  { tg: "ዔጻት", en: "back", de: "Rücken", fr: "dos", ar: "ظهر" },
  ...
  { tg: "ድሙ", en: "cat", de: "Katze", fr: "chat", ar: "قطة" },
  { tg: "ብግዕት", en: "sheep", de: "Schaf", fr: "mouton", ar: "خروف" },
  { tg: "ጠሊት", en: "goat (f)", de: "Ziege (f)", fr: "chèvre (f)", ar: "عنزة" },
  { tg: "ዲርሆ", en: "chicken, hen", de: "Huhn, Henne", fr: "poule, poulet", ar: "دجاجة" },
  { tg: "ሀበይ", en: "monkey", de: "Affe", fr: "singe", ar: "قرد" },
  { tg: "ዐንጻይ", en: "mouse", de: "Maus", fr: "souris", ar: "فأر" },
  { tg: "አርዌ", en: "snake", de: "Schlange", fr: "serpent", ar: "أفعى" },
  { tg: "ከራይ", en: "hyena", de: "Hyäne", fr: "hyène", ar: "ضبع" },
  { tg: "ሐየት", en: "lion", de: "Löwe", fr: "lion", ar: "أسد" },
  { tg: "ሰሬራይ", en: "bird", de: "Vogel", fr: "oiseau", ar: "طائر" },
  { tg: "ዓሰ", en: "fish", de: "Fisch", fr: "poisson", ar: "سمكة" },
  { tg: "ጸሓይ", en: "sun", de: "Sonne", fr: "soleil", ar: "شمس" },
  { tg: "ወርሕ", en: "moon", de: "Mond", fr: "lune", ar: "قمر" },
  { tg: "ኮከብ", en: "star", de: "Stern", fr: "étoile", ar: "نجمة" },
  { tg: "ሰመ", en: "sky", de: "Himmel", fr: "ciel", ar: "سماء" },
  { tg: "ምድር", en: "earth, land", de: "Erde, Land", fr: "terre, pays", ar: "أرض" },
  { tg: "ማይ", en: "water", de: "Wasser", fr: "eau", ar: "ماء" },
  { tg: "ዝላም", en: "rain", de: "Regen", fr: "pluie", ar: "مطر" },
  { tg: "እሳት", en: "fire", de: "Feuer", fr: "feu", ar: "نار" },
  { tg: "ውልዋል/ሀወ/ሸማል", en: "wind", de: "Wind", fr: "vent", ar: "ريح" },
  { tg: "ዕጨት", en: "tree, wood", de: "Baum, Holz", fr: "arbre, bois", ar: "شجرة" },
  ...
  { tg: "ስገ", en: "meat", de: "Fleisch", fr: "viande", ar: "لحم" },
  { tg: "ዝብደት", en: "butter", de: "Butter", fr: "beurre", ar: "زبدة" },
  { tg: "መዐር", en: "honey", de: "Honig", fr: "miel", ar: "عسل" },
  { tg: "ጬወት", en: "salt", de: "Salz", fr: "sel", ar: "ملح" },
  { tg: "ቡን", en: "coffee", de: "Kaffee", fr: "café", ar: "قهوة" },
  { tg: "ስከር", en: "sugar", de: "Zucker", fr: "sucre", ar: "سكر" },
  { tg: "ቢጨት", en: "egg", de: "Ei", fr: "œuf", ar: "بيضة" },
  { tg: "ጉዕ", en: "pepper", de: "Pfeffer", fr: "piment", ar: "فلفل" },
  { tg: "ፉል", en: "bean", de: "Bohne", fr: "haricot", ar: "فول" },
  { tg: "ሕበዝ ካምር", en: "sourdough bread", de: "Sauerteigbrot", fr: "pain levé", ar: "خبز مخمر" },
  { tg: "ተመር", en: "dates (dried)", de: "Datteln (getrocknet)", fr: "dattes (sèches)", ar: "تمر" },
  { tg: "ጸዕደ", en: "white", de: "weiß", fr: "blanc", ar: "أبيض" },
  { tg: "ጸሊም", en: "black", de: "schwarz", fr: "noir", ar: "أسود" },
  { tg: "ቀይሕ", en: "red", de: "rot", fr: "rouge", ar: "أحمر" },
  { tg: "አክደር", en: "green", de: "grün", fr: "vert", ar: "أخضر" },
  { tg: "ዐቢ", en: "big", de: "groß", fr: "grand", ar: "كبير" },
  { tg: "ንኡሽ", en: "small", de: "klein", fr: "petit", ar: "صغير" },
  { tg: "ረዪም", en: "long, tall", de: "lang, hoch", fr: "long, grand (taille)", ar: "طويل" },
  { tg: "ሐጪር", en: "short", de: "kurz", fr: "court", ar: "قصير" },
  { tg: "ሰኒ", en: "good", de: "gut", fr: "bon", ar: "جيد" },
  { tg: "እኩይ/ክፉእ", en: "bad", de: "schlecht", fr: "mauvais", ar: "سيء" },
  { tg: "ሐዲስ", en: "new", de: "neu", fr: "nouveau", ar: "جديد" },
  { tg: "ገዲም", en: "old, first", de: "alt, erster", fr: "ancien, premier", ar: "قديم" },
  { tg: "ቅሩብ", en: "near", de: "nah", fr: "proche", ar: "قريب" },
  { tg: "ብዙሕ", en: "much, many", de: "viel", fr: "beaucoup", ar: "كثير" },
  { tg: "ግሩም", en: "beautiful", de: "hübsch, schön", fr: "joli, beau", ar: "جميل" },
  { tg: "ድቁብ", en: "strong", de: "stark", fr: "fort", ar: "قوي" },
  { tg: "ሓጥር", en: "brave", de: "tapfer, mutig", fr: "brave, courageux", ar: "شجاع" },
  { tg: "ቤት", en: "house", de: "Haus", fr: "maison", ar: "بيت" },
  { tg: "ባብ", en: "door", de: "Tür, Tor", fr: "porte", ar: "باب" },
  { tg: "ገበይ", en: "road, path", de: "Straße, Weg", fr: "route, chemin", ar: "طريق" },
  { tg: "ስም/ስሜት", en: "name", de: "Name", fr: "nom", ar: "اسم" },
  { tg: "ልባስ", en: "clothing", de: "Kleidung", fr: "vêtements", ar: "ملابس" },
  { tg: "ጀርደት/ሰኪን", en: "knife", de: "Messer", fr: "couteau", ar: "سكين" },
  { tg: "ክታብ", en: "book", de: "Buch", fr: "livre", ar: "كتاب" },
  { tg: "ሰይፍ", en: "sword", de: "Schwert", fr: "épée", ar: "سيف" },
  { tg: "ደሀብ/ወርቅ", en: "gold", de: "Gold", fr: "or", ar: "ذهب" },
  { tg: "ሽባክ", en: "window", de: "Fenster", fr: "fenêtre", ar: "نافذة" },
  { tg: "ዐድ", en: "village, tribe", de: "Dorf, Stamm", fr: "village, tribu", ar: "قرية" },
  { tg: "አካን", en: "place", de: "Ort, Platz", fr: "lieu, place", ar: "مكان" },
  { tg: "ዐራት", en: "bed", de: "Bett", fr: "lit", ar: "سرير" },
  { tg: "ወቀይ/ሽቅል", en: "work", de: "Arbeit", fr: "travail", ar: "عمل" },
  { tg: "ሖል/ሰነት", en: "year", de: "Jahr", fr: "année", ar: "سنة" },
  { tg: "ሰላዲ", en: "money", de: "Geld", fr: "argent", ar: "مال" },
  { tg: "ሰተ", en: "to drink", de: "trinken", fr: "boire", ar: "شرب" },
  { tg: "ጌሰ", en: "to go", de: "gehen", fr: "aller", ar: "ذهب" },
  { tg: "መጽአ/ዔረ", en: "to come", de: "kommen", fr: "venir", ar: "جاء" },
  { tg: "ረአ", en: "to see", de: "sehen", fr: "voir", ar: "رأى" },
  { tg: "ሰምዐ", en: "to hear", de: "hören", fr: "entendre", ar: "سمع" },
  { tg: "ቤለ", en: "to say, speak", de: "sagen, sprechen", fr: "dire, parler", ar: "قال" },
  { tg: "ሀበ", en: "to give", de: "geben", fr: "donner", ar: "أعطى" },
  { tg: "ሰክበ", en: "to sleep", de: "schlafen", fr: "dormir", ar: "نام" },
  { tg: "ኣመረ", en: "to know", de: "wissen, kennen", fr: "savoir, connaître", ar: "عرف" },
  { tg: "ቀርአ", en: "to read", de: "lesen", fr: "lire", ar: "قرأ" },
  ...
  { tg: "ትገሰ", en: "to sit down", de: "sich setzen", fr: "s'asseoir", ar: "جلس" },
  { tg: "ወደ", en: "to do, make", de: "tun, machen", fr: "faire", ar: "فعل" },
  { tg: "ስሜትከ ምን ተ?", en: "what is your name?", de: "Wie heißt du?", fr: "comment t'appelles-tu?", ar: "ما اسمك؟" },
  { tg: "ስምዬ/ስሜቼ…", en: "my name is…", de: "Mein Name ist…", fr: "je m'appelle…", ar: "اسمي…" },
  { tg: "አምር", en: "I know", de: "Ich weiß", fr: "je sais", ar: "أعرف" },
  { tg: "ኢአምር", en: "I don't know", de: "Ich weiß nicht", fr: "je ne sais pas", ar: "لا أعرف" },
  { tg: "ዐይብከ", en: "please (m)", de: "bitte (m)", fr: "s'il te plaît (m)", ar: "من فضلك" },
  { tg: "ነዐ እንሰር", en: "come here!", de: "Komm her!", fr: "viens ici!", ar: "تعال!" },
  { tg: "አነ ስፍሩይ ህሌኮ", en: "I am hungry", de: "Ich habe Hunger", fr: "j'ai faim", ar: "أنا جائع" },
  { tg: "ከም?", en: "how much?", de: "Wie viel?", fr: "combien?", ar: "كم؟" },
  { tg: "እተየ?", en: "where?", de: "Wo?", fr: "où?", ar: "أين؟" },
  { tg: "ፈጅር", en: "tomorrow", de: "morgen", fr: "demain", ar: "غداً" },
  { tg: "ሀለ", en: "there is / exists", de: "es gibt / vorhanden", fr: "il y a / existe", ar: "يوجد" },
  { tg: "አለቡ", en: "there is not", de: "es gibt nicht", fr: "il n'y a pas", ar: "لا يوجد" },
  { tg: "ደሐን ትትሌከ", en: "goodbye", de: "Auf Wiedersehen", fr: "au revoir", ar: "مع السلامة" },
  { tg: "አነ", en: "I", de: "ich", fr: "je", ar: "أنا" },
  { tg: "እንተ", en: "you (m)", de: "du (m.)", fr: "tu (m.)", ar: "أنتَ" },
  { tg: "እንቲ", en: "you (f)", de: "du (f.)", fr: "tu (f.)", ar: "أنتِ" },
  { tg: "ህቱ", en: "he", de: "er", fr: "il", ar: "هو" },
  { tg: "ህተ", en: "she", de: "sie", fr: "elle", ar: "هي" },
  { tg: "ሕነ", en: "we", de: "wir", fr: "nous", ar: "نحن" },
  { tg: "ህቶም", en: "they (m)", de: "sie (m. Pl.)", fr: "ils", ar: "هم" },
  { tg: "ህተን", en: "they (f)", de: "sie (f. Pl.)", fr: "elles", ar: "هن" },
  { tg: "ሚ", en: "what?", de: "was?", fr: "quoi?", ar: "ماذا؟" },
  { tg: "መን", en: "who?", de: "wer?", fr: "qui?", ar: "من؟" },
  { tg: "ኦሮት ነፈር", en: "someone (m)", de: "jemand (m.)", fr: "quelqu'un (m.)", ar: "شخص ما" },
  { tg: "ወለ ሐቴ", en: "nobody", de: "niemand", fr: "personne", ar: "لا أحد" },
  { tg: "ገሌ ጋር", en: "something", de: "etwas", fr: "quelque chose", ar: "شيء ما" },
  { tg: "ሴመ ኢኮን", en: "nothing", de: "nichts", fr: "rien", ar: "لا شيء" },
  { tg: "እሊ", en: "this (m)", de: "dieser (m.)", fr: "ce (m.)", ar: "هذا" },
  { tg: "እለ", en: "this (f)", de: "diese (f.)", fr: "cette (f.)", ar: "هذه" },
  { tg: "ቱ", en: "he is (copula)", de: "er ist", fr: "il est", ar: "هو (رابطة)" },
  { tg: "ተ", en: "she is (copula)", de: "sie ist", fr: "elle est", ar: "هي (رابطة)" },
  { tg: "ህቶም", en: "they are (m.pl)", de: "sie sind (m. Pl.)", fr: "ils sont", ar: "هم" },
  { tg: "ህተን", en: "they are (f.pl)", de: "sie sind (f. Pl.)", fr: "elles sont", ar: "هن" },
  { tg: "ኢኮን", en: "is not (negation)", de: "ist nicht", fr: "n'est pas", ar: "ليس" },
  { tg: "ዕስረ", en: "twenty", de: "zwanzig", fr: "vingt", ar: "عشرون" },
  { tg: "ሰላሰ", en: "thirty", de: "dreißig", fr: "trente", ar: "ثلاثون" },
  { tg: "አርበዐ", en: "forty", de: "vierzig", fr: "quarante", ar: "أربعون" },
  { tg: "ሕምሰ", en: "fifty", de: "fünfzig", fr: "cinquante", ar: "خمسون" },
  { tg: "ስሰ", en: "sixty", de: "sechzig", fr: "soixante", ar: "ستون" },
  { tg: "ምእት", en: "hundred", de: "hundert", fr: "cent", ar: "مئة" },
  { tg: "ዕልብ", en: "number, quantity", de: "Zahl, Menge", fr: "nombre, quantité", ar: "عدد" },
  { tg: "ሰልፍ/አዋላይ", en: "first", de: "erster", fr: "premier", ar: "أول" },
  { tg: "ካልኣይ", en: "second", de: "zweiter", fr: "deuxième", ar: "ثاني" },
  { tg: "ሳልእስ/ሳልሳይ", en: "third", de: "dritter", fr: "troisième", ar: "ثالث" },
  { tg: "ቀትለ", en: "to kill (Type A)", de: "töten (Typ A)", fr: "tuer (Type A)", ar: "قتل" },
  { tg: "ፈግረ", en: "to go out (Type A)", de: "hinausgehen (Typ A)", fr: "sortir (Type A)", ar: "خرج" },
  { tg: "ወደ", en: "to do (Type A)", de: "tun (Typ A)", fr: "faire (Type A)", ar: "فعل" },
  { tg: "ሰብረ", en: "to break (Type C)", de: "zerbrechen (Typ C)", fr: "briser (Type C)", ar: "كسر" },
  { tg: "ጀምዐ/ሓበረ", en: "to join (Type C)", de: "verbinden (Typ C)", fr: "assembler (Type C)", ar: "جمع" },
  { tg: "ኢአነ", en: "I am not", de: "ich bin nicht", fr: "je ne suis pas", ar: "لست" },
  { tg: "እት", en: "in, at, to", de: "in, an, zu", fr: "dans, à, en", ar: "في" },
  { tg: "ምን", en: "from", de: "von, aus", fr: "de, depuis", ar: "من" },
  { tg: "ምስል/እብ", en: "with, by", de: "mit, durch", fr: "avec, par", ar: "مع" },
  { tg: "እግል/አስክ", en: "for, to", de: "für, zu", fr: "à, pour", ar: "لـ" },
  { tg: "ሐቆ", en: "after, behind", de: "nach, hinter", fr: "après", ar: "بعد" },
  { tg: "ክምሰል", en: "like, as", de: "wie, als", fr: "comme", ar: "مثل" },
  { tg: "እምበል", en: "without", de: "ohne", fr: "sans", ar: "بدون" },
  { tg: "ወ", en: "and", de: "und", fr: "et", ar: "و" },
  { tg: "እው/ዎክ/ተሩ", en: "or", de: "oder", fr: "ou", ar: "أو" },
  { tg: "ደአም", en: "but", de: "aber", fr: "mais", ar: "لكن" },
  { tg: "ዶል", en: "when", de: "als, wenn", fr: "quand, lorsque", ar: "عندما" },
  { tg: "ሰበት እሊ", en: "because", de: "weil, da", fr: "parce que", ar: "لأن" },
  { tg: "ምንመ", en: "although", de: "obwohl", fr: "bien que", ar: "رغم أن" },
  { tg: "ሐንገል", en: "brain", de: "Gehirn", fr: "cerveau", ar: "دماغ" },
  { tg: "ወቅት/ወክድ/እዋን", en: "time", de: "Zeit", fr: "temps", ar: "وقت" },
  ...
  { tg: "ሐዲስ", en: "new", de: "neu", fr: "nouveau", ar: "جديد" },
  { tg: "ህድየት", en: "gift", de: "Geschenk", fr: "cadeau", ar: "هدية" },
  { tg: "ወአት ሕልብ", en: "milk cow", de: "Milchkuh", fr: "vache à lait", ar: "بقرة حلوب" },
  { tg: "ሕበዝ", en: "bread (baked)", de: "Brot (gebacken)", fr: "pain (cuit au four)", ar: "خبز مخبوز" },
  { tg: "ሜስ", en: "mead, hydromel", de: "Met", fr: "hydromel", ar: "عسل مخمر" },
  { tg: "ማይ መዐር", en: "honey water", de: "Honigwasser", fr: "eau miellée", ar: "ماء بعسل" },
  { tg: "ማደ", en: "roast meat (on stones)", de: "Grillfleisch (auf Steinen)", fr: "viande rôtie sur pierres", ar: "لحم مشوي" },
  { tg: "ሐሪጭ", en: "flour", de: "Mehl", fr: "farine", ar: "طحين" },
  { tg: "ለይሙን", en: "lemon", de: "Zitrone", fr: "citron", ar: "ليمون" },
  { tg: "ስከር", en: "sugar", de: "Zucker", fr: "sucre", ar: "سكر" },
  { tg: "ማሼለ", en: "sorghum", de: "Sorghum", fr: "dourra", ar: "ذرة رفيعة" },
  { tg: "ጸሓይ", en: "sun, light", de: "Sonne, Licht", fr: "soleil, lumière", ar: "شمس" },
  { tg: "ዘልመ", en: "to rain", de: "regnen", fr: "pleuvoir", ar: "أمطر" },
  { tg: "ሐምደ", en: "dew", de: "Tau", fr: "rosée", ar: "ندى" },
  { tg: "ሖጸ", en: "sand", de: "Sand", fr: "sable", ar: "رمل" },
  { tg: "ሕፈር", en: "to dig", de: "graben", fr: "creuser", ar: "حفر" },
  { tg: "ጊመት/ጊማይ", en: "cloud", de: "Wolke", fr: "nuage", ar: "سحابة" },
  { tg: "ህመም", en: "leopard", de: "Leopard", fr: "léopard", ar: "نمر" },
  { tg: "ሐሺል", en: "jackal", de: "Schakal", fr: "chacal", ar: "ابن آوى" },
  { tg: "ሐርማዝ", en: "elephant", de: "Elefant", fr: "éléphant", ar: "فيل" },
  { tg: "ሐሪሽ", en: "rhinoceros", de: "Nashorn", fr: "rhinocéros", ar: "وحيد القرن" },
  { tg: "ሐረውየ", en: "wild boar", de: "Wildschwein", fr: "sanglier", ar: "خنزير بري" },
  { tg: "ሀበይ", en: "monkey", de: "Affe", fr: "singe", ar: "قرد" },
  { tg: "ንህበት", en: "bee", de: "Biene", fr: "abeille", ar: "نحلة" },
  { tg: "ጋብ", en: "eagle", de: "Adler", fr: "aigle", ar: "نسر" },
  { tg: "ሾከን/ሾክነት", en: "gazelle", de: "Gazelle", fr: "gazelle", ar: "غزال" },
  { tg: "ሰገን", en: "ostrich", de: "Strauß", fr: "autruche", ar: "نعامة" },
  { tg: "ዕክሪብ", en: "wolf", de: "Wolf", fr: "loup", ar: "ذئب" },
  { tg: "ደቤለ", en: "billy goat", de: "Ziegenbock", fr: "bouc", ar: "تيس" },
  { tg: "ለገ/እጋል", en: "male calf", de: "männliches Kalb", fr: "veau mâle", ar: "عجل" },
  { tg: "መንተሌ", en: "hare", de: "Hase", fr: "lièvre", ar: "أرنب" },
  { tg: "ገብእ", en: "to be, to exist", de: "sein, sich befinden", fr: "y être, se trouver", ar: "يكون" },
  { tg: "ሕልም", en: "to dream", de: "träumen", fr: "rêver", ar: "حلم" },
  { tg: "ሐልበ", en: "to milk", de: "melken", fr: "traire", ar: "حلب" },
  { tg: "ሐስበ", en: "to think", de: "denken", fr: "penser", ar: "فكر" },
  { tg: "ሐልፈ", en: "to pass", de: "vorbeigehen", fr: "passer", ar: "مرّ" },
  { tg: "ሕማም/ቀበ", en: "to fall ill", de: "erkranken", fr: "tomber malade", ar: "مرض" },
  { tg: "ሐስበ/ዐለበ", en: "to calculate", de: "berechnen", fr: "calculer", ar: "حسب" },
  { tg: "ሐሰ", en: "to lie", de: "lügen", fr: "mentir", ar: "كذب" },
  { tg: "ሐርሰ", en: "to plough", de: "pflügen", fr: "labourer", ar: "حرث" },
  { tg: "ሐረ/ነደ", en: "to burn", de: "verbrennen", fr: "se brûler", ar: "احترق" },
  { tg: "ሄረረ", en: "to walk fast", de: "schnell gehen", fr: "marcher vite", ar: "مشى بسرعة" },
  { tg: "ሰከ/ሀርበ", en: "to escape", de: "entfliehen", fr: "s'échapper", ar: "هرب" },
  { tg: "ሐረ", en: "to choose", de: "wählen", fr: "choisir", ar: "اختار" },
  { tg: "ሐርደ", en: "to slaughter", de: "schlachten", fr: "égorger", ar: "ذبح" },
  { tg: "ሐንቀ/ሸንቀ", en: "to strangle", de: "erdrosseln", fr: "étrangler", ar: "خنق" },
  { tg: "ሐነት/ዐምሰት", en: "to conceive", de: "empfangen", fr: "concevoir", ar: "حبلت" },
  { tg: "ሐከ", en: "to rub, scratch", de: "reiben, kratzen", fr: "frotter, gratter", ar: "حكّ" },
  { tg: "ሐዘ", en: "to want, desire", de: "wollen, wünschen", fr: "vouloir, désirer", ar: "أراد" },
  { tg: "ሐዘነ/ገሀ", en: "to grieve", de: "trauern", fr: "s'attrister", ar: "حزن" },
  { tg: "ሓየ", en: "to ignite, heal", de: "entzünden, heilen", fr: "s'allumer, guérir", ar: "أشعل" },
  { tg: "ሀደ", en: "to marry", de: "heiraten", fr: "se marier", ar: "تزوج" },
  { tg: "ሐድገ", en: "to abandon, divorce", de: "verlassen, scheiden", fr: "laisser, divorcer", ar: "ترك" },
  { tg: "ሐጭረ", en: "to shorten", de: "kürzen", fr: "devenir court", ar: "قصر" },
  { tg: "ሐጽበ", en: "to wash", de: "waschen", fr: "laver", ar: "غسل" },
  { tg: "ከጅለ", en: "to be ashamed", de: "sich schämen", fr: "avoir honte", ar: "خجل" },
  { tg: "ለሕሰ", en: "to lick", de: "lecken", fr: "lécher", ar: "لعق" },
  { tg: "ለምደ", en: "to get used to", de: "sich gewöhnen", fr: "s'habituer", ar: "تعوّد" },
  { tg: "ለቅሰ", en: "to lament", de: "klagen", fr: "se lamenter", ar: "ندب" },
  { tg: "ለብሰ", en: "to dress", de: "sich ankleiden", fr: "s'habiller", ar: "لبس" },
  { tg: "ለአከ/ነድአ", en: "to send", de: "senden", fr: "envoyer", ar: "أرسل" },
  { tg: "ባደለ", en: "to exchange", de: "tauschen", fr: "échanger", ar: "بادل" },
  { tg: "ሰፈ", en: "to sew", de: "nähen", fr: "coudre", ar: "خاط" },
  { tg: "መሐለ", en: "to swear", de: "schwören", fr: "jurer", ar: "أقسم" },
  { tg: "ረሕመ", en: "to have mercy", de: "Mitleid haben", fr: "avoir pitié", ar: "رحم" },
  { tg: "መልአ", en: "to fill", de: "füllen", fr: "remplir", ar: "ملأ" },
  { tg: "ሐክመ", en: "to rule", de: "herrschen", fr: "dominer", ar: "حكم" },
  { tg: "መርሐ", en: "to guide", de: "führen", fr: "guider", ar: "قاد" },
  { tg: "መሪር ገብአ", en: "to be bitter", de: "bitter werden", fr: "être amer", ar: "أصبح مرّاً" },
  { tg: "መጽአ", en: "to come", de: "kommen", fr: "venir", ar: "أتى" },
  { tg: "መወነ", en: "to nourish", de: "ernähren", fr: "nourrir", ar: "غذّى" },
  { tg: "ማሌ", en: "yesterday", de: "gestern", fr: "hier", ar: "أمس" },
  { tg: "ሰሐቀ", en: "to laugh", de: "lachen", fr: "rire", ar: "ضحك" },
  { tg: "ደሕነ/ሰልመ", en: "to be saved", de: "gerettet werden", fr: "se sauver", ar: "نجا" },
  { tg: "ሰልአስ", en: "three", de: "drei", fr: "trois", ar: "ثلاثة" },
  { tg: "ሰመ", en: "to name", de: "benennen", fr: "nommer", ar: "سمّى" },
  { tg: "ሸቀ", en: "to work, build", de: "arbeiten, bauen", fr: "travailler, bâtir", ar: "عمل" },
  { tg: "ሰበረ", en: "to break", de: "zerbrechen", fr: "briser", ar: "كسر" },
  { tg: "ሰተ", en: "to drink", de: "trinken", fr: "boire", ar: "شرب" },
  { tg: "ሰፍረ", en: "to be hungry", de: "Hunger haben", fr: "avoir faim", ar: "جاع" },
  { tg: "ሰክረ", en: "to get drunk", de: "betrunken werden", fr: "s'enivrer", ar: "سكر" },
  { tg: "ሰለ", en: "to pray", de: "beten", fr: "prier", ar: "صلّى" },
  { tg: "ረግስ/ስስዒት", en: "to dance", de: "tanzen", fr: "danser", ar: "رقص" },
  { tg: "ሰይፍ", en: "sword", de: "Schwert", fr: "épée", ar: "سيف" },
  { tg: "ሰዐር", en: "grass", de: "Gras", fr: "herbe", ar: "عشب" },
  { tg: "ተለ", en: "to follow", de: "folgen", fr: "suivre", ar: "تبع" },
  { tg: "ተመ/ከለሰ", en: "to be fulfilled", de: "erfüllt werden", fr: "s'accomplir", ar: "اكتمل" },
  { tg: "ሰእየት", en: "hope", de: "Hoffnung", fr: "espérance", ar: "أمل" },
  { tg: "ተርጀመ", en: "to translate", de: "übersetzen", fr: "traduire", ar: "ترجم" },
  { tg: "ዘርአ", en: "to plant", de: "pflanzen", fr: "planter", ar: "زرع" },
  { tg: "ደሐነ", en: "to be saved", de: "sich retten", fr: "se sauver", ar: "نجا" },
  { tg: "ተልሀ", en: "to play", de: "spielen", fr: "jouer", ar: "لعب" },
  { tg: "ደረረ", en: "to dine", de: "zu Abend essen", fr: "dîner", ar: "تعشّى" },
  { tg: "ተዕበ", en: "to get tired", de: "müde werden", fr: "se fatiguer", ar: "تعب" },
  { tg: "ደግመ", en: "to repeat", de: "wiederholen", fr: "répéter", ar: "كرّر" },
  { tg: "ደፈነ", en: "to bury", de: "begraben", fr: "enterrer", ar: "دفن" },
  { tg: "ተርፈ/ጸንሐ", en: "to stay, live", de: "bleiben, wohnen", fr: "rester, demeurer", ar: "بقي" },
  { tg: "በከ", en: "to cry", de: "weinen", fr: "pleurer", ar: "بكى" },
  { tg: "ተሃገ", en: "to speak", de: "sprechen", fr: "parler", ar: "تكلّم" },
  { tg: "ታጅር", en: "to trade", de: "handeln", fr: "commercer", ar: "تاجر" },
  { tg: "ነጽሐ", en: "to be pure", de: "rein sein", fr: "être pur", ar: "طهر" },
  { tg: "ገንሐ/አቅመተ", en: "to look", de: "schauen", fr: "regarder", ar: "نظر" },
  { tg: "ነፍስ", en: "soul", de: "Seele", fr: "âme", ar: "نفس" },
  { tg: "ነፈዐ", en: "to be useful", de: "nützlich sein", fr: "se rendre utile", ar: "نفع" },
  { tg: "ኩሉ", en: "all, every", de: "alles, jeder", fr: "tout", ar: "كل" },
  { tg: "ገዚፍ/ገናድ", en: "very big, giant", de: "sehr groß, Riese", fr: "très grand, géant", ar: "عملاق" },
  { tg: "አንያብ", en: "two", de: "zwei", fr: "deux", ar: "اثنان" },
  { tg: "ከበሮ/ደሉከት", en: "drum", de: "Trommel", fr: "tambour", ar: "طبل" },
  { tg: "ከትበ", en: "to write", de: "schreiben", fr: "écrire", ar: "كتب" },
  { tg: "ወልደ", en: "to give birth", de: "gebären", fr: "accoucher", ar: "ولد" },
  { tg: "ወርሰ", en: "to inherit", de: "erben", fr: "hériter", ar: "ورث" },
  { tg: "ወድቀ", en: "to fall", de: "fallen", fr: "tomber", ar: "سقط" },
  { tg: "ወጥነ", en: "to try", de: "versuchen", fr: "tenter", ar: "حاول" },
  { tg: "ተምነ", en: "to think", de: "nachdenken", fr: "réfléchir", ar: "تأمل" },
  { tg: "ወደ", en: "to do", de: "tun", fr: "faire", ar: "فعل" },
  { tg: "ረአ", en: "to see", de: "sehen", fr: "voir", ar: "رأى" },
  { tg: "ዘምተ", en: "to conquer", de: "erobern", fr: "conquérir", ar: "غزا" },
  { tg: "ጌሰ", en: "to go", de: "gehen", fr: "aller", ar: "ذهب" },
  { tg: "ፈህመ", en: "to understand", de: "verstehen", fr: "comprendre", ar: "فهم" },
  { tg: "ፍልሐ", en: "to boil", de: "kochen", fr: "bouillir", ar: "غلى" },
  { tg: "ፈርሀ", en: "to fear", de: "sich fürchten", fr: "avoir peur", ar: "خاف" },
  { tg: "አፍረ", en: "to bear fruit", de: "Frucht tragen", fr: "fructifier", ar: "أثمر" },
  { tg: "ከስተ/ፈትሐ", en: "to open", de: "öffnen", fr: "ouvrir", ar: "فتح" },
  { tg: "ፈተ", en: "to love", de: "lieben", fr: "aimer", ar: "أحبّ" },
  { tg: "ደፍዐ", en: "to pay", de: "bezahlen", fr: "payer", ar: "دفع" },
  { tg: "ፈጥረ/ከልቀ/መነ", en: "to create", de: "erschaffen", fr: "créer", ar: "خلق" },
  { tg: "ከትበ", en: "to write", de: "schreiben", fr: "écrire", ar: "كتب" },
  { tg: "ጸልመተ", en: "to darken", de: "dunkel werden", fr: "s'obscurcir", ar: "أظلم" },
  { tg: "አበ", en: "to hate", de: "hassen", fr: "haïr", ar: "كره" },
  { tg: "ጸምአ", en: "to be thirsty", de: "Durst haben", fr: "avoir soif", ar: "عطش" },
  { tg: "ሶመ", en: "to fast", de: "fasten", fr: "jeûner", ar: "صام" },
  { tg: "ጾረ", en: "to carry", de: "tragen", fr: "porter", ar: "حمل" },
  { tg: "ጸዕደ", en: "white", de: "weiß", fr: "blanc", ar: "أبيض" },
  { tg: "ጭብዕት", en: "finger", de: "Finger", fr: "doigt", ar: "إصبع" },
  { tg: "ሕልቅም/ሕልቅመት", en: "throat, voice", de: "Kehle, Stimme", fr: "gorge, voix", ar: "حلق" },
  ...
  { tg: "ምልትሕ", en: "cheek", de: "Wange", fr: "joue", ar: "خد" },
  { tg: "መርከብ/ፎቃይ", en: "shoulder", de: "Schulter", fr: "épaule", ar: "كتف" },
  { tg: "ዔጻት/ነዳይት", en: "the back", de: "der Rücken", fr: "le dos", ar: "الظهر" },
  ...
  { tg: "ሕማም/ቀበ/መረድ", en: "illness", de: "Krankheit", fr: "maladie", ar: "مرض" },
  { tg: "ሐዝ/ሕመት", en: "fever", de: "Fieber", fr: "fièvre", ar: "حمّى" },
  { tg: "ግንፈእ", en: "flu", de: "Grippe", fr: "grippe", ar: "إنفلونزا" },
  { tg: "ግርዝ", en: "boy, child", de: "Junge, Kind", fr: "garçon, enfant", ar: "طفل" },
  { tg: "ሐጺን", en: "iron", de: "Eisen", fr: "fer", ar: "حديد" },
  { tg: "ሐቂቀት/አማን", en: "truth", de: "Wahrheit", fr: "vérité", ar: "حقيقة" },
  { tg: "ሐዳድ", en: "blacksmith", de: "Schmied", fr: "forgeron", ar: "حداد" },
  { tg: "ሽማግሌ/ሼክ/በዐል ገጽ", en: "elder, judge", de: "Ältester, Richter", fr: "vieux, juge", ar: "شيخ" },
  { tg: "ሔልያይ", en: "singer", de: "Sänger", fr: "chanteur", ar: "مغني" },
  { tg: "ሞረ ራዒ", en: "shepherd's stick", de: "Hirtenstab", fr: "bâton de berger", ar: "عصا الراعي" },
  { tg: "ግድብ/ፋስ", en: "axe", de: "Axt", fr: "hache", ar: "فأس" },
  { tg: "ግድብ/ፋስ", en: "axe", de: "Axt", fr: "hache", ar: "فأس" },
  { tg: "መንከ", en: "wooden spoon", de: "Holzlöffel", fr: "cuillère de bois", ar: "ملعقة خشبية" },
  { tg: "ዐዳገ/ሱግ", en: "market", de: "Markt", fr: "marché", ar: "سوق" },
  { tg: "እብረት", en: "needle", de: "Nadel", fr: "aiguille", ar: "إبرة" },
  { tg: "ምድር/አርድ", en: "earth, ground", de: "Erde, Boden", fr: "terre, terrain", ar: "أرض" },
  { tg: "ምድር", en: "terrain", de: "Gelände", fr: "terrain", ar: "أرض" },
  { tg: "ድጌ", en: "village", de: "Dorf", fr: "village", ar: "قرية" },
  { tg: "ባዶግ", en: "desert", de: "Wüste", fr: "désert", ar: "صحراء" },
  { tg: "ሰፍረ/ፈለል", en: "hunger", de: "Hunger", fr: "la faim", ar: "جوع" },
  ...
  { tg: "ህግየ/ሂገ", en: "word, speech", de: "Wort, Rede", fr: "parole, discours", ar: "كلام" },
  { tg: "ንሳል/ልሳን", en: "tongue, language", de: "Zunge, Sprache", fr: "langue", ar: "لسان" },
  { tg: "ጨበል", en: "ash", de: "Asche", fr: "cendre", ar: "رماد" },
  { tg: "ሓበረ", en: "to mix, join", de: "mischen, vereinen", fr: "mêler, rejoindre", ar: "خلط" },
  { tg: "ሐቅፈ", en: "to embrace", de: "umarmen", fr: "embrasser", ar: "احتضن" },
  { tg: "ሔሰ", en: "to improve", de: "verbessern", fr: "s'améliorer", ar: "تحسّن" },
  { tg: "ሐብን", en: "honour, glory", de: "Ehre, Ruhm", fr: "honneur, gloire", ar: "شرف" },
  { tg: "መንጠሎን", en: "pants", de: "Hose", fr: "pantalon", ar: "بنطال" },
  { tg: "በለሰ/በለሰ", en: "heart, character", de: "Herz, Charakter", fr: "cœur, caractère", ar: "قلب" },
  { tg: "ጀረስ", en: "bell", de: "Glocke", fr: "cloche", ar: "جرس" },
  { tg: "እዲነ", en: "world", de: "Welt", fr: "monde", ar: "دنيا" },
  { tg: "ናይ", en: "of, belonging to", de: "von, gehörend zu", fr: "de, appartenant à", ar: "ملك" },
  { tg: "ነፍስ/ርሕ", en: "self", de: "selbst", fr: "soi-même", ar: "نفس" },
  { tg: "ነፍስ/ኖስ", en: "soul (literary)", de: "Seele (literarisch)", fr: "âme (littéraire)", ar: "نفس" },
  { tg: "ሕድሕዶም", en: "each other (two)", de: "einander (zwei)", fr: "l'un l'autre (deux)", ar: "بعضهما" },
  { tg: "ኖስኖሶም", en: "each other (many)", de: "einander (viele)", fr: "les uns les autres", ar: "بعضهم البعض" },

  // ─── Fruits ───
  { tg: "ትፈሕ", en: "apple", de: "Apfel", fr: "pomme", ar: "تفاح" },
  { tg: "በናነ", en: "banana", de: "Banane", fr: "banane", ar: "موز" },
  { tg: "አራንሺ", en: "orange", de: "Orange", fr: "orange", ar: "برتقال" },
  { tg: "መንገ", en: "mango", de: "Mango", fr: "mangue", ar: "مانجو" },
  { tg: "አናናስ", en: "pineapple", de: "Ananas", fr: "ananas", ar: "أناناس" },
  { tg: "ዕነብ", en: "grape", de: "Traube", fr: "raisin", ar: "عنب" },
  { tg: "ብርጪቅ", en: "watermelon", de: "Wassermelone", fr: "pastèque", ar: "بطيخ" },
  { tg: "ፈራውለ", en: "strawberry", de: "Erdbeere", fr: "fraise", ar: "فراولة" },
  { tg: "ምልሕጠ", en: "cherry", de: "Kirsche", fr: "cerise", ar: "كرز" },
  { tg: "አባንጉል", en: "peach", de: "Pfirsich", fr: "pêche", ar: "خوخ" },
  { tg: "ኮሚስ", en: "pear", de: "Birne", fr: "poire", ar: "كمثرى" },
  { tg: "በሀሽ", en: "kiwi", de: "Kiwi", fr: "kiwi", ar: "كيوي" },
  { tg: "ፓፓዮ", en: "papaya", de: "Papaya", fr: "papaye", ar: "بابايا" },
  { tg: "ለይሙን", en: "lemon", de: "Zitrone", fr: "citron", ar: "ليمون" },
  { tg: "ሎቢን", en: "lime", de: "Limette", fr: "citron vert", ar: "ليمون أخضر" },
  { tg: "ካካው", en: "coconut", de: "Kokosnuss", fr: "noix de coco", ar: "جوز الهند" },
  { tg: "በርጉግ", en: "plum", de: "Pflaume", fr: "prune", ar: "برقوق" },
  { tg: "በለስ", en: "fig", de: "Feige", fr: "figue", ar: "تين" },
  { tg: "ጀዋፈት", en: "guava", de: "Guave", fr: "goyave", ar: "جوافة" },
  { tg: "አቮካዶ", en: "avocado", de: "Avocado", fr: "avocat", ar: "أفوكادو" },

  // ─── Weather ───
  { tg: "ቃውዕ", en: "clear, bright", de: "klar", fr: "dégagé", ar: "صافٍ" },
  { tg: "ጉዩም", en: "cloudy", de: "bewölkt", fr: "nuageux", ar: "غائم" },
  { tg: "ዝላም", en: "rainy", de: "regnerisch", fr: "pluvieux", ar: "ممطر" },
  { tg: "ውልዋል", en: "windy", de: "windig", fr: "venteux", ar: "عاصف" },
  ...
  { tg: "ጋሙስ", en: "buffalo", de: "Büffel", fr: "buffle", ar: "جاموس" },
  { tg: "ህሌለ/ዕሉ", en: "foal (baby donkey)", de: "Eselfohlen", fr: "ânon", ar: "جحش" },
  { tg: "ዕንክር", en: "puppy", de: "Welpe", fr: "chiot", ar: "جرو" },
  { tg: "ነዊድ", en: "kid (baby goat)", de: "Zicklein", fr: "chevreau", ar: "جدي" },
  { tg: "ጭጭ", en: "chick", de: "Küken", fr: "poussin", ar: "كتكوت" },
  { tg: "ወነን", en: "tiger", de: "Tiger", fr: "tigre", ar: "نمر" },
  { tg: "ዔክሪብ", en: "wolf", de: "Wolf", fr: "loup", ar: "ذئب" },
  { tg: "ከንዚር", en: "pig", de: "Schwein", fr: "cochon", ar: "خنزير" },
  { tg: "ንህበት", en: "bee", de: "Biene", fr: "abeille", ar: "نحلة" },
  { tg: "ጥምብልዔተት", en: "butterfly", de: "Schmetterling", fr: "papillon", ar: "فراشة" },
  { tg: "አቅሕሞተት", en: "ant", de: "Ameise", fr: "fourmi", ar: "نملة" },
  { tg: "ዐንከቦት", en: "spider", de: "Spinne", fr: "araignée", ar: "عنكبوت" },
  { tg: "አርቀብ", en: "scorpion", de: "Skorpion", fr: "scorpion", ar: "عقرب" },
  { tg: "ሐናኒት/ጫጮት", en: "mosquito", de: "Mücke", fr: "moustique", ar: "بعوضة" },
  { tg: "ጭንጫይ", en: "fly", de: "Fliege", fr: "mouche", ar: "ذبابة" },
  { tg: "ቅመለት", en: "louse", de: "Laus", fr: "pou", ar: "قملة" },
  ...
  { tg: "ቅልጭም/ሕርቱመ", en: "arm", de: "Arm", fr: "bras", ar: "ذراع" },
  { tg: "ምንክብ", en: "elbow", de: "Ellbogen", fr: "coude", ar: "مرفق" },
  { tg: "ጭብዕት", en: "finger", de: "Finger", fr: "doigt", ar: "إصبع" },
  { tg: "ጽፍር እዴ", en: "fingernail", de: "Fingernagel", fr: "ongle", ar: "ظفر" },
  { tg: "ነሐር", en: "chest", de: "Brust", fr: "poitrine", ar: "صدر" },
  { tg: "ስጤት/ሰጥያት", en: "rib", de: "Rippe", fr: "côte", ar: "ضلع" },
  { tg: "ብርክ", en: "knee", de: "Knie", fr: "genou", ar: "ركبة" },
  { tg: "ወታድ", en: "heel", de: "Ferse", fr: "talon", ar: "كعب" },
  { tg: "አጫብዕ እግር", en: "toe", de: "Zeh", fr: "orteil", ar: "إصبع القدم" },
];
