...
const UI_TEXT = {
  // App title & tagline
  appTitle: { en: "ትግራይት", ar: "ትግራይት", fr: "ትግራይት" },
  appSubtitle: { en: "Learn Tigre — Language of Eritrea", ar: "تعلم التقري — لغة إريتريا", fr: "Apprendre le Tigré — Langue d'Érythrée" },
  ...
  // Flashcards screen
  tapToReveal: { en: "tap to reveal ትግራይት", ar: "اضغط لإظهار الترجمة", fr: "appuyez pour révéler" },
