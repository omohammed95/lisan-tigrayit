...
const UI_TEXT = {
  ...
  navProgress: { en: "Progress", ar: "التقدم", fr: "Progrès", de: "Fortschritt" },
  ...
  eachConsonant: { en: "Each consonant has 7 vowel forms — tap any row to explore", ar: "لكل حرف 7 أشكال صوتية — اضغط للاستكشاف", fr: "Chaque consonne a 7 formes vocaliques — appuyez pour explorer", de: "Jeder Konsonant hat 7 Vokalformen — tippe eine Zeile an" },

  // Flashcards screen
  tapToReveal: { en: "tap to reveal Tigre", ar: "اضغط لإظهار الترجمة", fr: "appuyez pour révéler", de: "Tippen zum Aufdecken" },
  play: { en: "Play", ar: "تشغيل", fr: "Jouer", de: "Abspielen" },
  record: { en: "Record", ar: "تسجيل", fr: "Enregistrer", de: "Aufnahme" },
  stop: { en: "Stop", ar: "إيقاف", fr: "Arrêter", de: "Stopp" },

  // Exercise screen
  score80: { en: "Score 80% to unlock the next level!", ar: "احصل على 80% لفتح المستوى التالي!", fr: "Obtenez 80% pour débloquer le niveau suivant!", de: "80% erreichen, um das nächste Level freizuschalten!" },
  alphabetQuiz: { en: "Alphabet Quiz", ar: "اختبار الأبجدية", fr: "Quiz Alphabet", de: "Alphabet-Quiz" },
  identifyLetters: { en: "Identify letters & romanized forms", ar: "حدد الحروف وأشكالها", fr: "Identifier les lettres et translittérations", de: "Buchstaben & Umschrift erkennen" },
  ...
  typeEnglish: { en: "What does this mean in English?", ar: "ما معناها بالإنجليزية؟", fr: "Que signifie ceci en anglais?", de: "Was bedeutet das auf Englisch?" },
  typePlaceholder: { en: "Type the English meaning…", ar: "اكتب المعنى بالإنجليزية…", fr: "Tapez la signification en anglais…", de: "Englische Bedeutung eingeben…" },
  ...
  whichRomanized: { en: "What is the romanized form of this letter?", ar: "ما الشكل اللاتيني لهذا الحرف؟", fr: "Quelle est la transcription de cette lettre?", de: "Wie lautet die lateinische Umschrift?" },
  ...
  resetProgress: { en: "Reset All Progress", ar: "إعادة تعيين التقدم", fr: "Réinitialiser le Progrès", de: "Gesamten Fortschritt zurücksetzen" },

  // Grammar Quiz
  grammarQuiz: { en: "Grammar Quiz", ar: "اختبار القواعد", fr: "Quiz Grammaire", de: "Grammatik-Quiz" },
  identifyGrammar: { en: "Test your grammar knowledge", ar: "اختبر معرفتك بالقواعد", fr: "Testez vos connaissances grammaticales", de: "Teste dein Grammatikwissen" },

  // Admin
  voiceAdmin: { en: "Voice Admin", ar: "إدارة الصوت", fr: "Admin Voix", de: "Sprach-Admin" },
  recordPronunciation: { en: "Record pronunciation for every word", ar: "سجل النطق لكل كلمة", fr: "Enregistrer la prononciation pour chaque mot", de: "Aussprache für jedes Wort aufnehmen" },
  audioCoverage: { en: "Audio coverage", ar: "تغطية الصوت", fr: "Couverture audio", de: "Audio-Abdeckung" },
  recorded: { en: "recorded", ar: "مسجل", fr: "enregistré", de: "aufgenommen" },
  back: { en: "Back", ar: "رجوع", fr: "Retour", de: "Zurück" },

  // Language names
  langEn: { en: "English", ar: "English", fr: "English", de: "English" },
  langAr: { en: "العربية", ar: "العربية", fr: "العربية", de: "العربية" },
  langFr: { en: "Français", ar: "Français", fr: "Français", de: "Français" },
  langDe: { en: "Deutsch", ar: "Deutsch", fr: "Deutsch", de: "Deutsch" },
};
